...
import { DateOption, Doctor } from "@/interfaces";
 ...
 * @returns JSX.Element
 */
const DoctorSchedule = ({doctor}: {doctor: Doctor}) => {
    ...
    return (
        <div>
            ...
            <div className="grid gap-6 mb-6 md:grid-cols-2">
                <Input labelDescription="Nome Médico" name="doctor-name" type="text" disabled={true} value={doctor.nome}/>
                <Input labelDescription="Especialidade" name="doctor-especiality" type="text" disabled={true} value={doctor.especialidade}/>
                <Input labelDescription="CRM" name="doctor-crm" type="text" disabled={true} value={doctor.crm}/>
                <Input labelDescription="Telefone" name="doctor-phone" type="phone" disabled={true} value={doctor.telefone}/>
