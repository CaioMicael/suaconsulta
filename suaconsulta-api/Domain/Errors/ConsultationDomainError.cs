namespace suaconsulta_api.Domain.Errors
{
    ...
    public class ConsultationDomainError : DomainError
    {
        ...
        /// <summary>
        /// Lança um bad request quando a data da consulta for menor que a data atual
        /// </summary>
        ...
        /// <summary>
        /// Lança um bad request quando a data da consulta não estiver disponível na agenda do médico
        /// </summary>
